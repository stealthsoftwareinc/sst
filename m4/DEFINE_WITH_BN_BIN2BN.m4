...
AC_DEFUN_ONCE([DEFINE_WITH_BN_BIN2BN], [[{

#
# The block that contains this comment is the expansion of the
# DEFINE_WITH_BN_BIN2BN macro.
#]dnl
m4_ifdef(
  [DEFINE_WITH_BN_BIN2BN_HAS_BEEN_CALLED],
  [gatbps_fatal([
    DEFINE_WITH_BN_BIN2BN has already been called
  ])],
  [m4_define([DEFINE_WITH_BN_BIN2BN_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    DEFINE_WITH_BN_BIN2BN requires exactly 0 arguments
