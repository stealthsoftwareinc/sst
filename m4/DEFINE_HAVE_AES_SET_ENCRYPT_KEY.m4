...
AC_DEFUN([DEFINE_HAVE_AES_SET_ENCRYPT_KEY], [[{

#
# The block that contains this comment is the expansion of the
# DEFINE_HAVE_AES_SET_ENCRYPT_KEY macro.
#]dnl
m4_ifdef(
  [DEFINE_HAVE_AES_SET_ENCRYPT_KEY_HAS_BEEN_CALLED],
  [gatbps_fatal([
    DEFINE_HAVE_AES_SET_ENCRYPT_KEY has already been called
  ])],
  [m4_define([DEFINE_HAVE_AES_SET_ENCRYPT_KEY_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    DEFINE_HAVE_AES_SET_ENCRYPT_KEY requires exactly 0 arguments
