...
AC_DEFUN_ONCE([DEFINE_SST_WITH_SST_NETTLE_CIPHER_FUNC], [[{

#
# The block that contains this comment is the expansion of the
# DEFINE_SST_WITH_SST_NETTLE_CIPHER_FUNC macro.
#]dnl
m4_ifdef(
  [DEFINE_SST_WITH_SST_NETTLE_CIPHER_FUNC_HAS_BEEN_CALLED],
  [gatbps_fatal([
    DEFINE_SST_WITH_SST_NETTLE_CIPHER_FUNC has already been called
  ])],
  [m4_define([DEFINE_SST_WITH_SST_NETTLE_CIPHER_FUNC_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    DEFINE_SST_WITH_SST_NETTLE_CIPHER_FUNC requires exactly 0 arguments
