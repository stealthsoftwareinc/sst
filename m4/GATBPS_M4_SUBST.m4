...
dnl
dnl Special file: GATBPS_M4_SUBST.m4
dnl
dnl For more information, see the GATBPS manual.
dnl
#serial 20200927
AC_DEFUN([GATBPS_M4_SUBST], [[{

#
# The block that contains this comment is the expansion of the
# GATBPS_M4_SUBST macro.
#]dnl
m4_ifdef(
  [GATBPS_M4_SUBST_HAS_BEEN_CALLED],
  [gatbps_fatal([
    GATBPS_M4_SUBST has already been called
  ])],
  [m4_define([GATBPS_M4_SUBST_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    GATBPS_M4_SUBST requires exactly 0 arguments
