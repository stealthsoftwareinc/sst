...
AC_DEFUN_ONCE([DEFINE_WYNA_AES_NI], [
...
{ :
  ...
  GATBPS_ARG_WYNA(
    [--with-aes-ni],
    [
      Use the AES-NI instruction set.
    ],
    [
      Do not use the AES-NI instruction set.
    ],
    [
      Automatically decide whether to use the AES-NI instruction set.
    ],
    [
      --with-sse
      --with-sse2
