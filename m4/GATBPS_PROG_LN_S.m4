...
dnl
dnl Special file: GATBPS_PROG_LN_S.m4
dnl
dnl For more information, see the GATBPS manual.
dnl
#serial 20200927
AC_DEFUN([GATBPS_PROG_LN_S_check_macros], [dnl
m4_ifndef(
  [gatbps_fatal],
  [dnl
m4_errprintn(
...
[GATBPS_PROG_LN_S_check_macros[]dnl
]))[]dnl
AC_DEFUN([GATBPS_PROG_LN_S], [[{

#
# The block that contains this comment is the expansion of the
# GATBPS_PROG_LN_S macro.
#]dnl
m4_ifdef(
  [GATBPS_PROG_LN_S_HAS_BEEN_CALLED],
  [gatbps_fatal([
    GATBPS_PROG_LN_S has already been called
  ])],
  [m4_define([GATBPS_PROG_LN_S_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    GATBPS_PROG_LN_S requires exactly 0 arguments
