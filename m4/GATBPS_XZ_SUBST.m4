...
dnl
dnl Special file: GATBPS_XZ_SUBST.m4
dnl
...
# GATBPS_XZ_SUBST macro.
#]dnl
m4_ifdef(
  [GATBPS_XZ_SUBST_HAS_BEEN_CALLED],
  [gatbps_fatal([
    GATBPS_XZ_SUBST has already been called
  ])],
  [m4_define([GATBPS_XZ_SUBST_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    GATBPS_XZ_SUBST requires exactly 0 arguments
