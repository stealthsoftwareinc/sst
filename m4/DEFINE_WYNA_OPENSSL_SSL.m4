...
AC_DEFUN_ONCE([DEFINE_WYNA_OPENSSL_SSL], [
...
{ :
  ...
  GATBPS_ARG_WYNA(
    [--with-openssl-ssl],
    [
      Use the OpenSSL ssl library.
    ],
    [
      Do not use the OpenSSL ssl library.
    ],
    [
      Automatically decide whether to use the OpenSSL ssl library.
    ],
    [
      --with-openssl-crypto
    ])
