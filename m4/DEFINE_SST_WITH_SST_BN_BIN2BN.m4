...
AC_DEFUN_ONCE([DEFINE_SST_WITH_SST_BN_BIN2BN], [[{

#
# The block that contains this comment is the expansion of the
# DEFINE_SST_WITH_SST_BN_BIN2BN macro.
#]dnl
m4_ifdef(
  [DEFINE_SST_WITH_SST_BN_BIN2BN_HAS_BEEN_CALLED],
  [gatbps_fatal([
    DEFINE_SST_WITH_SST_BN_BIN2BN has already been called
  ])],
  [m4_define([DEFINE_SST_WITH_SST_BN_BIN2BN_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    DEFINE_SST_WITH_SST_BN_BIN2BN requires exactly 0 arguments
...
AC_REQUIRE([DEFINE_SST_WITH_SST_BN_BIN2BN_STEP])
AC_REQUIRE([DEFINE_WITH_OPENSSL_CRYPTO])

GATBPS_CHECK_EXPR(
  [sst_BN_bin2bn],
  [SST_WITH_SST_BN_BIN2BN],
  [1
    && WITH_BIGNUM
    && WITH_BN_CTX
    && WITH_OPENSSL_BN_H
