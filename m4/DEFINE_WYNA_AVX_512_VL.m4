...
AC_DEFUN_ONCE([DEFINE_WYNA_AVX_512_VL], [
...
{ :
  ...
  GATBPS_ARG_WYNA(
    [--with-avx-512-vl],
    [
      Use the AVX-512 VL instruction set.
    ],
    [
      Do not use the AVX-512 VL instruction set.
    ],
    [
      Automatically decide whether to use the AVX-512 VL instruction
      set.
    ],
    [
      --with-avx-512-f
