...
AC_DEFUN_ONCE([DEFINE_WITH_POSIX], [[
...
{ :
    ...
    [(1
        ...
        || (1
          && WYNA_POSIX_IS_YES
          && WITH_POSIX_CPP_RUN_is_guess
        )
      )
    ])[

  case $][{WYNA_POSIX_IS_YES?}$][{WITH_POSIX?} in 10)
    ]GATBPS_BARF([
      The POSIX API is not available.
    ])[
  esac
