...
AC_DEFUN_ONCE([DEFINE_SST_WITH_SST_NETTLE_SIZE], [[{

#
# The block that contains this comment is the expansion of the
# DEFINE_SST_WITH_SST_NETTLE_SIZE macro.
#]dnl
m4_ifdef(
  [DEFINE_SST_WITH_SST_NETTLE_SIZE_HAS_BEEN_CALLED],
  [gatbps_fatal([
    DEFINE_SST_WITH_SST_NETTLE_SIZE has already been called
  ])],
  [m4_define([DEFINE_SST_WITH_SST_NETTLE_SIZE_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    DEFINE_SST_WITH_SST_NETTLE_SIZE requires exactly 0 arguments
