...
dnl
dnl Special file: GATBPS_PROG_TAR.m4
dnl
dnl For more information, see the GATBPS manual.
dnl
#serial 20200927
AC_DEFUN([GATBPS_PROG_TAR_check_macros], [dnl
m4_ifndef(
  [gatbps_fatal],
  [dnl
m4_errprintn(
...
[GATBPS_PROG_TAR_check_macros[]dnl
]))[]dnl
AC_DEFUN([GATBPS_PROG_TAR], [[{

#
# The block that contains this comment is the expansion of the
# GATBPS_PROG_TAR macro.
#]dnl
m4_ifdef(
  [GATBPS_PROG_TAR_HAS_BEEN_CALLED],
  [gatbps_fatal([
    GATBPS_PROG_TAR has already been called
  ])],
