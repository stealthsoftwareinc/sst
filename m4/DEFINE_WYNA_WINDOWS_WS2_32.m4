...
AC_DEFUN_ONCE([DEFINE_WYNA_WINDOWS_WS2_32], [
...
{ :
  ...
  GATBPS_ARG_WYNA(
    [--with-windows-ws2-32],
    [
      Use the Windows ws2_32 API.
    ],
    [
      Do not use the Windows ws2_32 API.
    ],
    [
      Automatically decide whether to use the Windows ws2_32 API.
    ],
    [
      --with-windows
