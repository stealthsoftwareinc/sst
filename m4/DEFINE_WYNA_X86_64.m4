...
AC_DEFUN_ONCE([DEFINE_WYNA_X86_64], [
...
{ :
  ...
  GATBPS_ARG_WYNA(
    [--with-x86-64],
    [
      Use the x86-64 instruction set.
    ],
    [
      Do not use the x86-64 instruction set.
    ],
    [
      Automatically decide whether to use the x86-64 instruction set.
    ],
    [
    ])
