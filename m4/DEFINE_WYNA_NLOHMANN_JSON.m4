...
AC_DEFUN_ONCE([DEFINE_WYNA_NLOHMANN_JSON], [[
...
{ :
    ...
    [--with-nlohmann-json],
    [
      Use the JSON for Modern C++ library.
    ],
    [
      Do not use the JSON for Modern C++ library.
    ],
    [
      Automatically decide whether to use the JSON for Modern C++
      library.
    ])[
