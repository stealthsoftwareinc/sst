...
#ifndef SRC_SST_BITGF_OVERLAP_H
#define SRC_SST_BITGF_OVERLAP_H
...
#define SST_BITGF_OVERLAP_STR2(x) #x

#define SST_BITGF_OVERLAP_STR1(x) SST_BITGF_OVERLAP_STR2(x)

#define SST_BITGF_OVERLAP(sst_bitGf, sst_bitG1, min, max) \
                    ...
                    if (s1_x != re + 1) { \
                      ...
                      if (prints != 0) { \
                        print_bad_evaluation( \
                          SST_BITGF_OVERLAP_STR1(sst_bitGf), \
                          sizeof(s1), \
                          s1, r1n, r1r, \
                          r2n, r2r, \
                          rn, rr, \
