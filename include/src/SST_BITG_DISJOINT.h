...
#ifndef SRC_SST_BITG_DISJOINT_H
#define SRC_SST_BITG_DISJOINT_H
...
#define SST_BITG_DISJOINT_STR2(x) #x

#define SST_BITG_DISJOINT_STR1(x) SST_BITG_DISJOINT_STR2(x)

#define SST_BITG_DISJOINT(sst_bitG, sst_bitG1, min, max) \
                    ...
                    if (s1_x != re + 1) { \
                      ...
                      if (prints != 0) { \
                        print_bad_evaluation( \
                          SST_BITG_DISJOINT_STR1(sst_bitG), \
                          sizeof(s1), \
                          s1, r1n, r1r, \
                          s2, r2n, r2r, \
                          rn, rr, \
